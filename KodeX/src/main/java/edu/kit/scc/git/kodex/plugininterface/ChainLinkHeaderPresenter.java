...
import edu.kit.scc.git.kodex.presenter.IPresenter;
import javafx.scene.layout.AnchorPane;

/**
 * This class represents an abstract HeaderPresenter for a specific link. It ensures that the header
 * belonging to the content of the level can be displayed.
 *
