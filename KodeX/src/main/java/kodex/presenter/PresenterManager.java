...
/**
 * 
 * This class manages the main presenters and keeps a reference to the root
 * stage. It gets the views for the root stage from its current presenter and
 * side menu presenter.
 * 
...
public class PresenterManager {
    ...
    /**
     * This method initiates the updating of the main view by setting the center of
     * the BorderPane layout with the view of the current presenter.
     */
    ...
    /**
     * This method initiates the updating of the side menu view by setting the left
     * side of the BorderPane layout with the view of the SideMenuPresenter.
     */
    ...
    /**
     * This method sets the presenter that is currently active and displays its
     * view.
     * 
