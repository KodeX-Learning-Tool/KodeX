...
/**
 * This abstract class specifies which information about a procedure should be known and manages it.
 * Every plugin must extend this class. However, the description, the labels and the icon do not
 * have to be implemented (standard values).
 *
...
public abstract class ProcedureInformation {
   ...
   *
   * @return description of the procedure Note: The description is limited to a string
   */
